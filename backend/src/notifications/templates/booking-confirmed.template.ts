...
export function bookingConfirmedTemplate(ctx: BookingConfirmedContext): {
  subject: string;
  html: string;
} {
  return {
    subject: `✅ Booking Confirmed — ${ctx.venueName} (${ctx.date})`,
    html: `
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:#ecfdf5;padding:20px 40px;text-align:center;border-bottom:1px solid #d1fae5;">
              <span style="display:inline-block;background:#10b981;color:#fff;padding:8px 20px;border-radius:20px;font-size:14px;font-weight:600;">
                ✅ Booking Confirmed
              </span>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 28px;color:#6b7280;font-size:15px;line-height:1.6;">
                Great news! Your booking has been confirmed and payment received. See your booking details below.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;margin-bottom:28px;">
                <tr>
                  <td colspan="2" style="background:#1a56db;padding:14px 20px;">
                    <span style="color:#ffffff;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">📋 Booking Details</span>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding:14px 20px;color:#6b7280;font-size:14px;border-bottom:1px solid #e2e8f0;">Location</td>
                  <td style="padding:14px 20px;color:#111827;font-size:14px;font-weight:600;border-bottom:1px solid #e2e8f0;">${ctx.city}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding:14px 20px;color:#6b7280;font-size:14px;border-bottom:1px solid #e2e8f0;">Time</td>
                  <td style="padding:14px 20px;color:#111827;font-size:14px;font-weight:600;border-bottom:1px solid #e2e8f0;">${ctx.startTime} – ${ctx.endTime}</td>
                </tr>
                <tr>
                  <td style="padding:14px 20px;color:#6b7280;font-size:14px;">Amount Paid</td>
                  <td style="padding:14px 20px;color:#10b981;font-size:16px;font-weight:700;">LKR ${ctx.totalPrice}</td>
                </tr>
              </table>

              <p style="margin:0;color:#6b7280;font-size:14px;line-height:1.6;">
                Please arrive 10 minutes early. If you need to cancel, remember cancellations must be made <strong>at least 1 hour</strong> before your slot.
              </p>
            </td>
          </tr>
