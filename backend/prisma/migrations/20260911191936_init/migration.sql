-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'VENUE_OWNER', 'CUSTOMER');
...
-- CreateEnum
CREATE TYPE "SportType" AS ENUM ('BADMINTON', 'TENNIS', 'FUTSAL', 'BASKETBALL', 'SQUASH', 'CRICKET_NET');
...
-- CreateIndex
CREATE INDEX "Court_sportType_idx" ON "Court"("sportType");
